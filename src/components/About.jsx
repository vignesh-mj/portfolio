...
const CATS = [
  ...
  },
  {
    ...
    accent: '#00d4ff',
    desc: 'Managing complex, async app state with Redux Toolkit and Context API for scalable, predictable data flows across feature modules.',
    img: 'https://images.unsplash.com/photo-1461749280684-dccba630e2f6?auto=format&fit=crop&w=900&q=85',
    skills: ['Redux Toolkit', 'Redux', 'Context API', 'Formik'],
  },
  {
    icon: '🎨',
    name: 'UI & Styling',
  ...
  },
  {
    ...
    name: 'Backend & APIs',
    accent: '#10b981',
    desc: 'Building and consuming RESTful APIs with Node.js, Express, Axios, and Fetch API — defining API contracts and handling complex async workflows.',
    img: 'https://images.unsplash.com/photo-1558494949-ef010cbdcc31?auto=format&fit=crop&w=900&q=85',
    skills: ['Node.js', 'Express.js', 'REST APIs', 'Axios', 'Fetch API', 'MongoDB'],
  },
  {
    icon: '🛠️',
    name: 'Tools & Workflow',
    accent: '#f59e0b',
    desc: 'Streamlined dev workflow using Git, Figma, Chrome DevTools, and VS Code — with AI tools like GitHub Copilot to accelerate delivery.',
